...
const DAY_02: Day = {
  ...
  desc: "Selected teams return with their Day 01 progress and continue developing their solutions toward the final demonstration and evaluation.",
  slots: [
    {
      id: "d2-1",
      time: "09:00 — 09:15",
    ...
    },
    {
      ...
      title: "LUNCH & NETWORKING",
      label: "PAUSE · CONNECT · RESET",
      body: "Take a break before the final presentation phase and connect with fellow participants and mentors.",
      kind: "break",
    },
    {
      id: "d2-5",
      ...
      label: "PREPARE · DEMONSTRATE · COMMUNICATE",
      body: "Prepare the final demonstration. Organize the presentation, finalize the prototype, and make sure your team can clearly communicate the problem, solution, technology, and impact.",
    },
    {
      id: "d2-6",
      time: "13:30 — 14:30",
      ...
      body: "Teams present their completed solutions to the evaluation panel and demonstrate the working prototype.",
    ...
    },
    {
      ...
      label: "EVALUATE · RECOGNIZE · CLOSE",
      body: "The final solutions are evaluated, followed by the closing session and recognition of the participating teams.",
      kind: "milestone",
    },
  ],
};
