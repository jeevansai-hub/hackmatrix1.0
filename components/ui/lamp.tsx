...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[500px] flex-col items-center justify-center overflow-hidden bg-[#030303] w-full rounded-3xl z-0 py-20 border border-white/5",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-red-600 opacity-40 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
      ...
      <div className="relative z-50 flex flex-col items-center px-5 pt-8 w-full">
        {children}
      </div>
    </div>
  );
