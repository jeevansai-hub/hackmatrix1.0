...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-0 shrink-0 scale-[0.45] transform flex-col items-center justify-start -my-40 py-0 [perspective:800px] sm:my-0 sm:scale-75 md:min-h-[140vh] md:scale-100 md:py-24"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        >
          <span className="text-white font-mono font-bold text-xl tracking-widest">
            VIIT AI &amp; DS
          </span>
        </div>
      </div>
      <motion.div
        ...
        className="absolute inset-0 h-96 w-[32rem] rounded-2xl bg-[#010101] p-2 overflow-hidden border border-white/10"
      >
        <div className="absolute inset-0 rounded-lg bg-[#070709] p-4 flex flex-col justify-center items-center text-center overflow-hidden">
          {children}
        </div>
      </motion.div>
    </div>
